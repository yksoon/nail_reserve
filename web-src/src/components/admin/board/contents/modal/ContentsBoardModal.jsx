...
const ContentsBoardModal = (props) => {
    ...
    /**
     * 컨텐츠 구분
     * @type {[{ko: string, en: string},{ko: string, en: string}]}
     */
        ...
        if (validation()) {
            ...
            const doRegModBoard = () => {
                ...
                const data = {
                    ...
                    content: boardData,
                    email: category === "영상" ? refs.email.current.value : "",
                };
    ...
    const validation = () => {
        ...
        if (category === "영상" && !refs.email.current.value) {
            noti(refs.email, "영상 링크를 입력해주세요");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            onChange={(e) =>
                                                handleUrlString(e.target.value)
                                            }
                                        />
                                    </td>
                                </tr>
...
export default ContentsBoardModal;
