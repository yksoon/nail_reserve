        ...
        switch (type) {
            case "add":
                ...
                newState.forEach((room) => {
                    if (room.reserve_guest_info.length >= room.max_people) {
                        CommonNotify({
                            type: "alert",
                            hook: alert,
                            message: "객실 허용 최대 인원을 넘을 수 없습니다.",
                        });
...
export default ReserveGuestSelect;
